 ...
 */
    ...
    class ChinaCityAddon extends Addon{
        ...
        public function J_China_City($param){
        	$param['province_name'] = $param['province_name'] ? $param['province_name'] : 'province';
        	$param['city_name'] = $param['city_name'] ? $param['city_name'] : 'city';
        	$param['district_name'] = $param['district_name'] ? $param['district_name'] : 'district';
