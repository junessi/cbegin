...
class ForumController extends AdminController
{
    ...
    public function editForum($id = null, $title = '', $create_time = 0, $status = 1, $allow_user_group = 0, $logo = 0)
    {
        if (IS_POST) {
            ...
            'district'=>I('district',0,'intval') , 'stage' => I('stage',1,'intval') , 'quotas' => I('quotas',1,'intval') ,'partners' => I('partners' ,0 ,'intval'),
            ...
            /* 项目区域 */
			$district_id_array = get_district_id_array();
			
			/* 项目阶段 */
			$stage_id_array = C('PROJECT_STAGE');
			
			/* 项目投资额度 */
			$quotas_id_array = C('PROJECT_QUOTAS');
			
			/*项目合伙人*/
			$partnets_is_array = C('PROJECT_PARTNERS');
            ...
            $builder
                ...
                ->keySelect('district', '所在区域', '选择项目所在区域' , $district_id_array)
                ->keySelect('stage', '项目阶段', '选择项目所在阶段' ,$stage_id_array)
                ->keySelect('quotas', '项目投资额度' ,'选择项目投资额度', $quotas_id_array)
                ->keySelect('partners', '需要合伙人', '' ,$partnets_is_array)
