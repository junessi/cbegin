...
class ConfigController extends BaseController
{
    ...
    public function index($uid = null, $tab = '', $nickname = '', $sex = 0, $email = '', $signature = ''
        , $community = 0, $district = 0, $city = 0, $province = 0 ,$idtag = 0 ,$home_province = 0 ,$home_city = 0 ,$home_district = 0)
    {
        ...
        if (IS_POST) {
            ...
            $idtag = intval(trim($idtag));
            $home_province = intval(trim($home_province));
            $home_city = intval(trim($home_city));
            $home_district = intval(trim($home_district));
            ...
            $user['idtag'] = $idtag;
            $user['home_province'] = $home_province;
            $user['home_city'] = $home_city;
            $user['home_district'] = $home_district;
            $user['focus'] = $focus;
            ...
            clean_query_user_cache(get_uid(), array('nickname', 'sex', 'signature', 'email', 'pos_province', 'pos_city', 'pos_district', 'pos_community' ,
            											'idtag' , 'home_province' ,'home_city','home_district' , 'focus'));
            ...
            //调用API获取基本信息
            //TODO tox 获取省市区数据
            $user = query_user(array('nickname', 'signature', 'email', 'mobile', 'avatar128', 'rank_link', 'sex', 'pos_province', 'pos_city', 'pos_district', 'pos_community',
	            					'idtag' ,'home_province' ,'home_city','home_district' , 'focus'), $uid);
            //显示页面
    ...
    public function getDirection(){
    	...
    	$directions = M("ProjectTags")->where($map)->select();
