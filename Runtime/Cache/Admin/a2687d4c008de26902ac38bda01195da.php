        ...
        <div class="bd">
            <div class="sys-info">
                <table>
                    <tr>
                        <th>核心版本</th>
                        <td>One Think v<?php echo (ONETHINK_VERSION); ?>&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                        <th>内核版权所有</th>
                        <td><a href="http://www.topthink.net/" target="_blank">上海顶想信息科技公司</a> | <a href="http://www.onethink.cn" target="_blank">OneThink内容发布框架</a></td>
                    </tr>
                </table>
            </div>
        </div>
