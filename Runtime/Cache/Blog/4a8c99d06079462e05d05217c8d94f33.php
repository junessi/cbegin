    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-8  ">
                <?php if(($info["cover_id"]) != "0"): ?><div><img style="width: 100% " src="<?php echo (get_cover($info["cover_id"],'path')); ?>" alt="<?php echo (op_t($info["title"])); ?>"/></div><?php endif; ?>
				...
				<span class="pull-left">
                     <?php $user=query_user(array('avatar32','space_url'),$info['uid']) ?>
					<span class="author"><a href="<?php echo ($user["space_url"]); ?>"
                                            ucard="<?php echo ($info["uid"]); ?>"><?php echo (get_nickname($info["uid"])); ?></a></span>
				...
				<span class="pull-right">
                    ...
                    <div style="padding: 20px">
                        <?php echo hook('localComment', array('path'=>"Blog/Article/$info[id]", 'uid'=>$info['uid']));?>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-md-4">
                <div class="common_block_border">
                    ...
                    <?php $author=query_user(array('nickname','space_url','avatar64','signature'),$info['uid']) ?>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <br/>
                        文章：<?php echo D('Document')->where(array('uid'=>$info['uid'],'status'=>1))->count(); ?>
                    </div>
                    <div class="clearfix" style="padding: 10px"></div>
                </div>
                <?php echo W('Position/lists',array('position'=>2,'category'=>$category['id']));?>
