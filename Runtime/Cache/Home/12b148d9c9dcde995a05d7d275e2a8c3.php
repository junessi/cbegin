...
<div class="breadcrumbs ">
	<div class="container">
		<h1 class="pull-left">发布<?php echo ($type); ?></h1>
		<ul class="pull-right breadcrumb">
            <li><a href="/">首页</a></li>
            <li><a href="/project/">创业集结</a></li>
            <li><a href="<?php echo U('release');?>">发布<?php echo ($type); ?></a></li>
        </ul>
	</div>
</div>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8 news-left">
			<div  class="project-release row">
				
				<form action="/project/release/category_id/52/direction/" method="post" id="form-release">
					<div class="col-md-3">
						<div class="form-group">
					    <select class="form-control" name="region">
					    	<?php $_result=get_project_region();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					    </select>
					  </div>
					</div>
					...
					<div class="col-md-9">
						<div class="form-group">
						    <input type="text" class="form-control" id="title" placeholder="<?php echo ($type); ?>标题" name="title">
						</div>
					</div>
					
					<?php if(($category_id) == "51"): ?><div class="col-md-12">
					<div class="form-group">
						<span ><?php echo ($type); ?>LOGO：</span>
						<?php echo W('Common/UploadImage/render',array(array('id'=>'logo_img','name'=>'logo_img','width'=>'150','height'=>'150','value'=>'')));?>
					</div>
					</div><?php endif; ?>
					
					<div class="col-md-12">
						<div class="form-group">
							<span ><?php echo ($type); ?>行业：</span>
							<?php $_result=get_project_sel('industry');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="radio" name="industry" value="<?php echo ($vo["id"]); ?>" data-direction="" class="project-industry"> <span><?php echo ($vo["title"]); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div>
					
					<div class="col-md-12">
						<div class="form-group">
							<span ><?php echo ($type); ?>方向：</span>
							<span class="project-direction"></span>
					...
					<div class="col-md-12">
						<div class="form-group">
							<span >发展阶段：</span>
							<?php $_result=get_project_sel('stage');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="radio" name="stage" value="<?php echo ($vo["id"]); ?>"> <span><?php echo ($vo["title"]); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div>
					
					<div class="col-md-12">
						<div class="form-group">
							<textarea name="advantage" class="form-control" rows="3" placeholder="<?php echo ($type); ?>优势"></textarea>
						</div>
					</div>
					...
					<?php if(($category_id) == "51"): ?><div class="col-md-12">
						<div class="form-group">
							<span >资金来源：</span>
							<?php $_result=get_project_sel('funds');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="radio" name="funds" value="<?php echo ($vo["id"]); ?>"> <span><?php echo ($vo["title"]); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div><?php endif; ?>
					<?php if(($category_id) == "51"): ?><div class="col-md-12">
						<div class="form-group">
							<span >投资额度：</span>
							<?php $_result=get_project_sel('quotas');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="radio" name="quotas" value="<?php echo ($vo["id"]); ?>"> <span><?php echo ($vo["title"]); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div><?php endif; ?>
					
					<?php if(($category_id) == "51"): ?><div class="col-md-12">
						<div class="form-group">
							<textarea name="team" class="form-control" rows="3" placeholder="团队情况"></textarea>
						</div>
					</div><?php endif; ?>
					...
					<?php if(($category_id) == "51"): ?><div class="col-md-12">
						<div class="form-group">
							<span >需要合伙人：</span>
							<?php $_result=get_project_sel('partners');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="radio" name="partners" value="<?php echo ($vo["id"]); ?>"> <span><?php echo ($vo["title"]); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div><?php endif; ?>
					...
					<?php if(($category_id) == "51"): ?><div class="col-md-12">
						<div class="form-group">
							<span >合作方式：</span>
							<?php $_result=get_project_sel('partners_mode');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="radio" name="partners_mode" value="<?php echo ($vo["id"]); ?>"> <span><?php echo ($vo["title"]); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
					</div><?php endif; ?>
					
					<?php if(($category_id) == "51"): ?><div class="col-md-12">
						<div class="form-group">
							<textarea name="partners_require" class="form-control" rows="3" placeholder="合伙人要求"></textarea>
						</div>
					</div><?php endif; ?>
					
					<?php if(($category_id) == "51"): ?><div class="col-md-12">
						<div class="form-group">
							<textarea name="partners_duty" class="form-control" rows="3" placeholder="合伙人职责"></textarea>
						</div>
					</div><?php endif; ?>
					
					<?php if(($category_id) == "51"): ?><div class="col-md-12">
						<div class="form-group">
							<textarea name="partners_return" class="form-control" rows="3" placeholder="合伙人回报"></textarea>
						</div>
					</div><?php endif; ?>
					
					<?php if(($category_id) == "52"): ?><div class="col-md-12">
							<div class="form-group">
							<input type="text" class="form-control" name="invest_quotas" placeholder="投资额度" >
							</div>
						</div>
						
						<div class="col-md-12">
							<div class="form-group">
								<textarea name="invest_return" class="form-control" rows="3" placeholder="投资回报"></textarea>
							</div>
						</div><?php endif; ?>
					...
					<div class="col-md-12">
						<p><?php echo ($type); ?>其它说明</p>
						<p>
						<?php echo W('UeditorMini/editor',array('contentEditor','content',$post['content'],'100%','200px',''));?>
						</p>
					</div>
					...
					<div class="col-md-12">
						<div class="form-group">
							<label>视频链接：</label>
						    <input type="text" class="form-control" id="video" placeholder="视频链接，优酷，土豆等自己上传的<?php echo ($type); ?>介绍" name="video">
						</div>
					</div>
...
<link type="text/css" rel="stylesheet" href="/Public/Core/js/ext/atwho//atwho.css"/>
	...
	<script >
	$(function (){
		$('.project-industry').bind('click',function (){
			var obj = $(this);
			var id = obj.val();
			var direction = obj.attr('data-direction');
			var direction_inputs = '';
			if(direction == ""){
				$.post("<?php echo U('getDirection');?>",{id:id},function(data){
					for(var i=0;i<data.length;i++){
						direction_inputs += "<input type='radio' name='direction' value='"+data[i]['id']+"' > "+data[i]['title']+" ";
						$('.project-direction').html(direction_inputs);
						obj.attr({'data-direction':direction_inputs});
					}
					
				},'json');
			}
			else{
				$('.project-direction').html(direction);
			}
		});
	});
	</script>
