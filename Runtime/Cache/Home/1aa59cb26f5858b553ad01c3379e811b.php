...
<div id="main-container" class="container">
    ...
    <section>
        ...
        <div class="common_block_border login-form-inbox ">
            <div class="login-text"><strong><h1><?php echo C('WEB_SITE');?>密码找回</h1></strong></div>
            <form class="login-form" id="J_findpwd_form" action="<?php echo U('user/mi');?>" method="post">
                ...
                <a class="btn btn-default" href="<?php echo U('User/login');?>">再去登录</a>
