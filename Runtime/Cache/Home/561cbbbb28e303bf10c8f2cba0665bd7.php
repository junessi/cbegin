...
<div class="breadcrumbs ">
	<div class="container">
		<h1 class="pull-left"><?php echo ($category["title"]); ?></h1>
		<ul class="pull-right breadcrumb">
            <li><a href="/">首页</a></li>
            <li><a href="/news/">资讯</a></li>
            <li><a href="/news/<?php echo ($category['name']); ?>/"><?php echo ($category["title"]); ?></a></li>
        </ul>
	</div>
</div>
...
<div id="main-container" class="container">
  ...
  <li role="presentation" <?php if(($pageType) == "all"): ?>class="active"<?php endif; ?> ><a href="/news/">全部</a></li>
  <?php if(is_array($categoryNav)): foreach($categoryNav as $key=>$vo): ?><li role="presentation" <?php if(($currentCate["id"]) == $vo['id']): ?>class="active"<?php endif; ?> ><a href="/news/<?php echo ($vo['name']); ?>/"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; ?>
</ul>
			
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="row news-items-box">
				<div class="col-md-8 news-item-category"><?php echo (get_category_info($vo["category_id"])); ?></div>
				<div class="col-md-4 news-item-time text-right">
					<span >/</span>
					<span><?php echo ($vo['is_original'] ? '原创' : '转载'); ?> / </span>
					<span><?php echo (format_news_time($vo["create_time"])); ?></span>
				</div>
				<div class="clearfix"></div>
				<?php if(!empty($vo["cover_id"])): ?><div class="col-md-3"><a href="<?php echo U('detail?id='.$vo['id']);?>"><img src="<?php echo (get_cover($vo["cover_id"],'path')); ?>" width="100%"></a></div>
					<div class="col-md-9">
						<h2 class="news-item-title">
							<a href="<?php echo U('detail?id='.$vo['id']);?>"><?php echo ($vo["title"]); ?></a>
						</h2>
						<p class="news-item-description"><a href="<?php echo U('detail?id='.$vo['id']);?>"><?php echo ($vo["description"]); ?></a></p>
						<p class="news-item-info text-right">
							<span>阅读量 ：<em><?php echo ($vo["view"]); ?></em></span>
							<span>评论量 <a href="<?php echo U('detail?id='.$vo['id']);?>#comment" ><i class="fa fa-comment-o"></i>：<em><?php echo ($vo["comment"]); ?></em></a></span>
							<span class="rating do-zan" data-id="<?php echo ($vo["id"]); ?>" data-zan="0"><i class="star news-zan"></i>：<em><?php echo ($vo["zan"]); ?></em></span>
							<span class="collection do-collection" data-id="<?php echo ($vo["id"]); ?>">收藏 <i class="heart"></i>：<em><?php echo ($vo['collection'] ? $vo['collection'] : 0); ?></em></span>
						</p>
						<p class="text-right"><a href="<?php echo U('detail?id='.$vo['id']);?>">查看详情</a></p>
					</div>
				<?php else: ?>
					<div class="col-md-3">
						<a href="<?php echo U('usercenter/index/index?uid='.$vo['uid']);?>" ucard="<?php echo ($vo["uid"]); ?>"><img src='<?php echo (get_user_avatar($vo["uid"])); ?>' class="avatar-img img-responsive" ></a> 
					</div>
					<div class="col-md-9">
						<h2 class="news-item-title">
							<a href="<?php echo U('detail?id='.$vo['id']);?>"><?php echo ($vo["title"]); ?></a>
						...
						<p class="news-item-description"><a href="<?php echo U('detail?id='.$vo['id']);?>"><?php echo ($vo["description"]); ?></a></p>
						<p class="news-item-info text-right">
							<span>阅读次数 ：<em><?php echo ($vo["view"]); ?></em></span>
							<span>评论量 <a href="<?php echo U('detail?id='.$vo['id']);?>#comment" ><i class="fa fa-comment-o"></i>：<em><?php echo ($vo["comment"]); ?></em></a></span>
							<span class="rating do-zan" data-id="<?php echo ($vo["id"]); ?>" data-zan="0">点赞 <i class="star new-zan"></i>：<em><?php echo ($vo["zan"]); ?></em></span>
							<span class="collection do-collection" data-id="<?php echo ($vo["id"]); ?>">收藏 <i class="heart"></i>：<em><?php echo ($vo['collection'] ? $vo['collection'] : 0); ?></em></span>
						</p>
						<p class="text-right"><a href="<?php echo U('detail?id='.$vo['id']);?>">查看详情</a></p>
					</div><?php endif; ?>
		...
		<div class="col-md-4  news-right">
			<div><a href="javascript:;" class="btn btn-primary btn-release">我来发布资讯</a></div>
	...
	<div class="col-md-12">
		<div class="user-box">
			<div class="row">
				...
				<div class="col-md-9 ">
					<p class="user-box-name"><?php echo ($self["nickname"]); ?></p>
				...
				<div class="col-md-12">
					<div class="user-box-count text-center">
						<div>
							<p>发布</p>
							<p><a href="<?php echo U('usercenter/index/news',array('uid'=>$self['uid'],'info_type'=>'release'));?>" ><?php echo ($self["news_count"]); ?></a></p>
						</div>
						<div>
							<p>收藏</p>
							<p><a href="<?php echo U('usercenter/index/news',array('uid'=>$self['uid'],'info_type'=>'collection'));?>" ><?php echo ($self["news_collection"]); ?></a></p>
						</div>
						<div>
							<p>评论</p>
							<p><a href="<?php echo U('usercenter/index/news',array('uid'=>$self['uid'],'info_type'=>'comment'));?>" ><?php echo ($self["news_comment"]); ?></a></p>
						</div>
					</div>
				</div>
...
<div class="my-news-lists">
	<p class="my-news-lists-title">浏览最多</p>
	
	<ul class="list-group">
	  <?php $_result=get_top_news('view');if(is_array($_result)): $k = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li class="list-group-item"><a href="<?php echo U('detail?id='.$vo['id']);?>" ><?php echo ($k); ?>.<?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
	</ul>
	
	<p class="my-news-lists-title">评论最多</p>
	
	<ul class="list-group">
	  <?php $_result=get_top_news('comment');if(is_array($_result)): $k = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li class="list-group-item"><a href="<?php echo U('detail?id='.$vo['id']);?>" ><?php echo ($k); ?>.<?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
	</ul>
	<p class="my-news-lists-title"> 收藏最多</p>
	
	<ul class="list-group">
	  <?php $_result=get_top_news('collection');if(is_array($_result)): $k = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li class="list-group-item"><a href="<?php echo U('detail?id='.$vo['id']);?>" ><?php echo ($k); ?>.<?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
	</ul>
	<p class="my-news-lists-title">赞最多</p>
	
	<ul class="list-group">
	  <?php $_result=get_top_news('zan');if(is_array($_result)): $k = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li class="list-group-item"><a href="<?php echo U('detail?id='.$vo['id']);?>" ><?php echo ($k); ?>.<?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
	</ul>
</div>
		</div>
...
<script src="/Public/Home/js/news.js"></script> <!-- 用于加载js代码 -->
<script>
    $(function() {
