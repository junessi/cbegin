        ...
        <div class="col-xs-10 col-xs-offset-1 register" style="margin-top: 60px;margin-bottom: 120px;">
            ...
            <div class="col-xs-12 rg_go">
                <div class="col-sm-4 col-xs-6" style="position: relative;padding: 0;margin-bottom: 20px;">
                    <img src="/Public/Home/images/start_image.png" class="img-responsive" alt="" style="height: 40px;">

                    <div style="margin-top: -35px;color: white;line-height: 30px;font-size: 16px;margin-left: 21px;">
                        填写用户信息
                    </div>
                </div>
                <?php $src_upload=$src_finish="/Public/Home/images/todo_image.png"; if($type=="upload"){ $src_upload="/Public/Home/images/finish_image.png"; }elseif($type=="finish"){ $src_upload=$src_finish="/Public/Home/images/finish_image.png"; } ?>
