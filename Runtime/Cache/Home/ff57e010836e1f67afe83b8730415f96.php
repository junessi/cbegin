	...
	<div class="col-md-8 news-left">
		...
		<div class="row">
			<div class="col-md-10">
				...
				<p>地区:<?php echo (get_district_by_id($info["region"])); ?> 发布时间:<?php echo (date('Y-m-d',$info["create_time"])); ?></p>
			</div>
			
			<div class="col-md-2">
				<a href="<?php echo U('usercenter/index/index?uid='.$info['uid']);?>" ucard="<?php echo ($info["uid"]); ?>" ><img src="<?php echo (get_cover($info["logo_img"],'path')); ?>" width="100%" ></a>
			</div>
			
			<div class="clearfix col-md-12"><hr></div>
			<div class="col-md-12 text-right">
				<a href="javascript:;" class="btn btn-zan do-zan" data-zan="0" data-id="<?php echo ($info["id"]); ?>">支持:<em><?php echo ($info["zan"]); ?></em></a>
				<a href="javascript:;" class="btn btn-collection do-collection" data-id="<?php echo ($info["id"]); ?>">关注:<em><?php echo ($info["collection"]); ?></em></a>
			</div>
			<div class="clearfix col-md-12"><hr></div>
			
			<div class="col-md-12">
				<p class="project-detial-item-name">所属行业： <span><?php echo (get_project_config($info["industry"],'industry')); ?></span></p>
			...
			<div class="col-md-12">
				<p class="project-detial-item-name">发展阶段: <span><?php echo (get_project_config($info["stage"],'stage')); ?></span></p>
				<?php if(($category["id"]) == "51"): ?><p class="project-detial-item-name">资金来源：<span><?php echo (get_project_config($info["funds"],'funds')); ?></span></p>
				<p class="project-detial-item-name">投资额度：<span><?php echo (get_project_config($info["quotas"],'quotas')); ?></span></p><?php endif; ?>
				<?php if(($category["id"]) == "52"): ?><p class="project-detial-item-name">投资额度：<span><?php echo ($info["invest_quotas"]); ?></span></p>
					<p class="project-detial-item-name">投资回报：<span><?php echo ($info["invest_return"]); ?></span></p><?php endif; ?>
				<p class="project-detial-item-name">项目优势：<span></span></p>
				<div class="project-detail-item-info"><?php echo ($info["advantage"]); ?></div>
			</div>
			
			<?php if(($category["id"]) == "51"): ?><div class="clearfix col-md-12"><hr></div>
				
				<div class="col-md-12">
					<p class="project-detial-item-name">团队情况：<span></span></p>
					<div class="project-detail-item-info"><?php echo ($info["team"]); ?></div>
				</div>
				
				<div class="clearfix col-md-12"><hr></div>
				
				<div class="col-md-12">
					<p class="project-detial-item-name">需要合伙人: <span><?php echo (get_project_config($info["partners"],'partners')); ?></span></p>
					<p class="project-detial-item-name">合作方式：<span><?php echo (get_project_config($info["partners_mode"],'partners_mode')); ?></span></p>
					<p class="project-detial-item-name">合伙人要求：<span><?php echo ($info["partners_require"]); ?></span></p>
					<p class="project-detial-item-name">合伙人职责：<span><?php echo ($info["partners_duty"]); ?></span></p>
					<p class="project-detial-item-name">合伙人回报：<span><?php echo ($info["partners_return"]); ?></span></p>
				</div><?php endif; ?>
			<div class="clearfix col-md-12"><hr></div>
			<div class="col-md-12">
				<p class="project-detial-item-name">项目详细说明：<span></span></p>
				<div class="project-detail-item-info"><?php echo ($info["content"]); ?></div>
			...
			<div class="col-md-12">
				...
				<div class="project-detail-item-info">
					<?php $_result=get_collection_lists($info['id']);if(is_array($_result)): $k = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if(($k) == "1"): ?><span><a href="<?php echo U('usercenter/index/index?uid='.$vo['uid']);?>" ucard='<?php echo ($vo["uid"]); ?>' ><?php echo ($vo["nickname"]); ?></a></span>
					<?php else: ?>
						<span> , <a href="<?php echo U('usercenter/index/index?uid='.$vo['uid']);?>" ucard='<?php echo ($vo["uid"]); ?>'><?php echo ($vo["nickname"]); ?></a></span><?php endif; endforeach; endif; else: echo "" ;endif; ?>
				</div>
			</div>
