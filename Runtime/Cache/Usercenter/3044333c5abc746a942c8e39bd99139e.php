                        ...
                        <div class="col-xs-12 uc_fans" style="margin-left: 10px;">
                            <ul class="nav nav-pills ucenter-tab">
                                <li><a href="<?php echo U('Usercenter/Index/rank',array('uid'=>$uid));?>"
                                    ...
                                    >
                                    已拥有头衔</a></li>
                                <?php if($uid == is_login()): ?><li><a href="<?php echo U('Usercenter/Index/rankVerifyWait');?>"
                        ...
                        <?php if(is_array($rankList)): $i = 0; $__LIST__ = $rankList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><div class="row"
                                ...
                                <div class="col-xs-2">
                                    <img style="width: 18px;margin-top: 30px;margin-left: 25px"
                                         src="<?php echo (get_cover($rank["logo"],'path')); ?>"/>
                                </div>
                                <div class="col-xs-8">
                                    <div>
                                        头衔名称：<?php echo ($rank["title"]); ?>
                                    </div>
                                    <div style="margin-top: 10px;">
                                        理由：<?php echo ($rank["reason"]); ?>
                                    </div>
                                    <div style="margin-top: 10px;">
                                        申请时间：<?php echo (friendlydate($rank["create_time"])); ?>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <?php if(($tab) == "rankVerifyWait"): ?><a class="btn btn-primary" href="<?php echo U('Usercenter/Index/rankVerifyCancel',array('rank_id'=>$rank['rank_id']));?>">取消申请</a><?php endif; ?>
                                    <?php if(($tab) == "rankVerifyFailure"): ?><a class="btn btn-primary" href="<?php echo U('Usercenter/Index/rankVerify',array('rank_user_id'=>$rank['id']));?>">重新申请</a><?php endif; ?>
                                </div>
