                ...
                <div class="col-md-7 col-xs-12">
                    <div class="row" style="margin-bottom: 20px;">
                        <div class="col-xs-12 uc_information" style="margin-left: 10px;">
                            <ul class="nav nav-pills ucenter-tab">
                                <li>
                                    <a href="<?php echo U('Usercenter/Index/news',array('uid'=>$uid,'info_type'=>'release'));?>"
                                    <?php if(($info_type) == "release"): ?>class="uc_current"<?php endif; ?>
                                    ><?php if($uid == is_login()): ?>我<?php else: ?>Ta<?php endif; ?>发布的资讯</a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Usercenter/Index/news',array('uid'=>$uid,'info_type'=>'collection'));?>"
                                    <?php if(($info_type) == "collection"): ?>class="uc_current"<?php endif; ?>
                                    ><?php if($uid == is_login()): ?>我<?php else: ?>Ta<?php endif; ?>收藏的资讯</a>
                               </li>
                               <li>
                                    <a href="<?php echo U('Usercenter/Index/news',array('uid'=>$uid,'info_type'=>'comment'));?>"
                                    <?php if(($info_type) == "comment"): ?>class="uc_current"<?php endif; ?>
                                    ><?php if($uid == is_login()): ?>我<?php else: ?>Ta<?php endif; ?>评论的资讯</a>
                               </li>
                            </ul>
                    ...
                    <div class="row uc_project">
                    	<?php if(($info_type) == "release"): if(is_array($lists)): foreach($lists as $key=>$vo): ?><div class="col-xs-12">
	                       			<p class="h3"><a href="<?php echo U('Home/news/detail?id='.$vo['id']);?>" ><?php echo ($vo["title"]); ?></a></p>
	                       			<p ><a href="<?php echo U('Home/news/detail?id='.$vo['id']);?>" ><?php echo ($vo["description"]); ?></a></p>
	                       			<p class="pull-left"><?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?> </p>
	                    ...
	                    <?php if(($info_type) == "collection"): if(is_array($lists)): foreach($lists as $key=>$vo): ?><div class="col-xs-12">
	                       			<p class="h3"><a href="<?php echo U('Home/news/detail?id='.$vo['id']);?>" ><?php echo ($vo["title"]); ?></a></p>
	                       			<p ><a href="<?php echo U('Home/news/detail?id='.$vo['id']);?>" ><?php echo ($vo["description"]); ?></a></p>
	                       			<p class="pull-left">收藏时间 ：<?php echo (date("Y-m-d H:i",$vo["collection_time"])); ?> </p>
	                       		</div><?php endforeach; endif; ?>
	                       	<div class="col-xs-12"><?php echo ($page); ?></div><?php endif; ?>
	                    <?php if(($info_type) == "comment"): if(is_array($lists)): foreach($lists as $key=>$vo): ?><div class="col-xs-12">
	                       			<p class="h5">评论内容：<a href="<?php echo U('Home/news/detail?id='.$vo['row_id']);?>#comment" ><?php echo ($vo["content"]); ?></a></p>
	                       			<p class="pull-left">评论时间 ：<?php echo (date("Y-m-d H:i",$vo["create_time"])); ?> </p>
	                       			<p class="pull-right">评论给 ：<a href="<?php echo U('Home/news/detail?id='.$vo['row_id']);?>" ><?php echo ($vo["title"]); ?></a></p>
	                       		</div><?php endforeach; endif; ?>
	                       	<div class="col-xs-12"><?php echo ($page); ?></div><?php endif; ?>
                    </div>
