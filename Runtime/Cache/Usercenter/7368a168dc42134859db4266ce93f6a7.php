                    ...
                    <div class="row" style="margin-bottom: 20px;">
                        <div class="col-xs-12 uc_information" style="margin-left: 10px;">
                            <ul class="nav nav-pills ucenter-tab">
                                <li>
                                    <a href="<?php echo U('Usercenter/Index/information',array('uid'=>$uid,'info_type'=>'base_info'));?>"
                                    <?php if(($info_type) == "base_info"): ?>class="uc_current"<?php endif; ?>
                                    >基本资料</a></li>
                                <li>
                                    <a href="<?php echo U('Usercenter/Index/information',array('uid'=>$uid,'info_type'=>'expand_info'));?>"
                                    <?php if(($info_type) == "expand_info"): ?>class="uc_current"<?php endif; ?>
                                    >扩展资料</a></li>
                            </ul>

                        </div>
                    </div>
                    <?php if(($info_type) == "base_info"): ?><div class="base_info">
                            ...
                            <dl class="dl-horizontal">
                                <dt>家乡：</dt>
                                <dd>
                                    <?php if(($user["home_province"]) == "0"): ?>还未设置
                                        <?php else: ?>
                                        <?php echo ($user["home_province"]); ?>&nbsp;&nbsp;<?php echo ($user["home_city"]); ?>&nbsp;&nbsp;<?php echo ($user["home_district"]); ?>&nbsp;&nbsp;<?php endif; ?>
                                </dd>
                            </dl>
                            
                            <dl class="dl-horizontal">
                                <dt>个性签名：</dt>
                                <dd><?php echo (htmlspecialchars($user["signature"])); ?></dd>
                            </dl>
                            
                            <dl class="dl-horizontal">
                            	<dt>关注方向：</dt>
                            	<dd><?php if(is_array($myFocus)): foreach($myFocus as $key=>$vo): ?><span><?php echo ($vo["title"]); ?>|</span><?php endforeach; endif; ?></dd>
                            </dl>
                        </div><?php endif; ?>
                    <?php if(($info_type) == "expand_info"): if(is_array($profile_group_list)): $i = 0; $__LIST__ = $profile_group_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group_vl): $mod = ($i % 2 );++$i;?><div class="panel panel-default" style="margin-left: 10px">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo ($group_vl["profile_name"]); ?></h3>
                                </div>
                                <div class="panel-body expand_info">
                                    <?php if(is_array($group_vl['info_list'])): $i = 0; $__LIST__ = $group_vl['info_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info_vl): $mod = ($i % 2 );++$i;?><dl class="dl-horizontal">
                                            ...
                                            <dd><?php echo ($info_vl["field_data"]); ?></dd>
                        ...
                        <?php if(count($profile_group_list) == 0): ?><p class="text-muted"
