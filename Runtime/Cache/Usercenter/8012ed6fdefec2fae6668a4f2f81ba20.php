<?php if (!defined('THINK_PATH')) exit(); if(($type) == "personal"): ?><div class="form-group">
        ...
        <div class="col-sm-6">
            <textarea class="form-control" onblur="check_textarea(this,<?php echo ($field_id); ?>)" require="<?php echo ($required); ?>" min_length="<?php echo ($validation["min"]); ?>" max_length="<?php echo ($validation["max"]); ?>" text_type="textarea" id="expand_<?php echo ($field_id); ?>" name="expand_<?php echo ($field_id); ?>"style="min-height: 100px;"><?php echo (htmlspecialchars($field_data)); ?></textarea>
