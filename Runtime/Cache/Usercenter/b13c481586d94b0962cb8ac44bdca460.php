                    ...
                    <div class="row">
                        <div class="col-xs-12 uc_fans" style="margin-left: 10px;">
                            <ul class="nav nav-pills ucenter-tab">
                                <li><a href="<?php echo U('Usercenter/Index/rank',array('uid'=>$uid));?>"
                                    <?php if(($tab) == "rank"): ?>class="uc_current"<?php endif; ?>
                                    >
                                    已拥有头衔</a></li>
                                <li><a href="<?php echo U('Usercenter/Index/rankVerifyWait');?>"
                                    <?php if(($tab) == "rankVerifyWait"): ?>class="uc_current"<?php endif; ?>
                                    >
                                    待审核头衔</a></li>
                                <li><a href="<?php echo U('Usercenter/Index/rankVerifyFailure');?>"
                                    <?php if(($tab) == "rankVerifyFailure"): ?>class="uc_current"<?php endif; ?>
                                    >
                                    申请失败头衔</a></li>
                                <li><a href="<?php echo U('Usercenter/Index/rankVerify');?>"
                                    <?php if(($tab) == "rankVerify"): ?>class="uc_current"<?php endif; ?>
                                    >
                                    申请头衔</a></li>
                            </ul>
                    ...
                    <?php if(count($rankList) == 0): ?><p class="text-muted"
                        ...
                        <div style="margin: 20px 0 20px 20px;">
                            <form class="form-horizontal center_info ajax-form" role="form"
                                  action="<?php echo U('Usercenter/Index/verify');?>" method="post">
                                <input type="hidden" name="rank_user_id" value="<?php echo ($old_rank_user['id']); ?>">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">申请头衔</label>

                                    <div class="col-sm-10">
                                        <?php if(is_array($rankList)): $i = 0; $__LIST__ = $rankList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><div class="col-xs-4 text-center">
                                                <label class="radio-inline">
                                                    <attr>
                                                    <p><img style="width: 18px;height: 18px" src="<?php echo (get_cover($rank["logo"],'path')); ?>"/></p>
                                                    <p> <input type="radio" name="rank_id" value="<?php echo ($rank["id"]); ?>" <?php if($rank['id'] == $old_rank_user['rank_id']): ?>checked<?php endif; ?>><?php echo ($rank["title"]); ?></p>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="reason" name="reason" class="form-control"
                                                  style="width: 100%; height: 6em;resize: none"><?php echo ($old_rank_user['reason']); ?></textarea>
                                    </div>
                                </div>
