                    ...
                    <div class="row">
                        <div class="col-xs-12 uc_fans" style="margin-left: 10px;">
                            <ul class="nav nav-pills ucenter-tab">
                                <li><a href="<?php echo U('Usercenter/Index/following',array('uid'=>$uid));?>"
                                    <?php if(($tab) == "following"): ?>class="uc_current"<?php endif; ?>
                                    >
                                    <?php if($uid == is_login()): ?>我<?php else: ?>Ta<?php endif; ?>的关注</a></li>
                                <li><a href="<?php echo U('Usercenter/Index/fans',array('uid'=>$uid));?>"
                                    <?php if(($tab) == "fans"): ?>class="uc_current"<?php endif; ?>
                                    >
                                    <?php if($uid == is_login()): ?>我<?php else: ?>Ta<?php endif; ?>的粉丝</a></li>
                            </ul>
