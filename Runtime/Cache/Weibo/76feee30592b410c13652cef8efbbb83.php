<?php if (!defined('THINK_PATH')) exit();?><script type="text/javascript" charset="utf-8" src="/Public/Core/js/ext/webuploader/js/webuploader.js"></script>
<link href="/Public/Core/js/ext/webuploader/css/webuploader.css" type="text/css" rel="stylesheet">
