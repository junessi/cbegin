            ...
            <div class="row">
            	<div class="col-md-12">
            		<div class="index-find-box">
            			<form role="form" class="index-search-form" action="<?php echo U('');?>" method="get">
            				...
            				<div class="row">
            					<div class="col-md-6">
            						<p>
            							...
            							<label><input type="radio" name="sex" value="2" <?php if(($info["sex"]) == "2"): ?>checked<?php endif; ?>> 女</label>
            							<label><input type="radio" name="sex" value="0" <?php if(empty($info["sex"])): ?>checked<?php endif; ?> > 不限</label>
            						</p>
            					</div>
            					...
            					<div class="clearfix"></div>
           						...
           						<p>
           						<?php echo hook('J_China_City',array('province'=>$info['pos_province'],'city'=>$info['pos_city'],'district'=>$info['pos_district'],'province_name'=>'pos_province','city_name'=>'pos_city','district_name'=>'pos_district'));?>
           						</p>
           						...
           						<div class="col-md-10 search-position">
           						<p>
           						<?php echo hook('J_China_City',array('province'=>$info['home_province'],'city'=>$info['home_city'],'district'=>$info['home_district'],'province_name'=>'home_province','city_name'=>'home_city','district_name'=>'home_district'));?>
           						</p>
           						</div>
            					...
            					<div class="col-md-10">
            						<p><select id="focus_sel">
            							<?php if(is_array(C("PROJECT_INDUSTRY"))): foreach(C("PROJECT_INDUSTRY") as $k=>$vo): ?><option value="<?php echo ($k); ?>" data-option="" class="focus-sel-<?php echo ($k); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; ?>
            							</select>
            						</p>
            		...
            		<div class="row">
            			<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><div class="col-md-6">
	            				<div class="find-user-box">
	            					<div class="row">
	            						
		            						<div class="col-md-4">
		            							<div><a href="<?php echo U('usercenter/index/index?uid='.$vo['uid']);?>" ><img src="<?php echo (get_user_avatar($vo["uid"])); ?>" ucard="<?php echo ($vo["uid"]); ?>" class="avatar-img img-responsive" width="100%"></a></div>
		            						</div>
		            						
		            						<div class="col-md-8">
		            							<p class="h4"><a href="<?php echo U('usercenter/index/index?uid='.$vo['uid']);?>" ><?php echo ($vo["nickname"]); ?></a></p>
		            							<p class="find-user-signature"><a href="<?php echo U('usercenter/index/index?uid='.$vo['uid']);?>" ><?php echo ($vo["signature"]); ?></a></p>
		            						</div>
            			...
            			<div class="col-md-12 page"><?php echo ($s_page); ?></div>
            		</div>
            	</div>
            </div><?php endif; ?>
    ...
    <script>
        ...
        $(function () {
        	 ...
        	 $('#focus_sel').bind('change',function (){
     			...
     			var obj = $(this);
     			var id = obj.val();
     			var check_option = <?php echo ($info["focus"]); ?>;
