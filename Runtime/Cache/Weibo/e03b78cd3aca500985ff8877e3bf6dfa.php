<?php if (!defined('THINK_PATH')) exit(); if($list['type'] == 2): if(count($list['res']) > 0): switch($list["style"]): case "2": ?><script src="/Public/Core/js/ext/kinmaxshow/js/kinmaxshow.min.js"></script>
            ...
            <?php default: ?>
                <script src="/Public/Core/js/ext/slider/js/jquery.slides.min.js"></script>
